...
public class SanPhamDao {
    ...
    public SanPham getSanPhamTheoMa(String masp) throws SQLException {
        ...
        while (rs.next()) {
            ...
            if (loaiSanPham.equals("Sách")) {
                sp = new Sach(maSanPham, loaiSanPham, soLuongTon, trongLuong, ncc, giaNhap, ghiChu, donViSanPham, hinhAnh, tenSach, tacGia, nhaXuatBan, namXuatBan, soTrang, theLoaiSach);
                return sp;
            } else {
                sp = new VanPhongPham(maSanPham, loaiSanPham, soLuongTon, trongLuong, ncc, giaNhap, ghiChu, donViSanPham, hinhAnh, tenVanPhongPham, loaiVanPhongPham, mauSac, chatLieu, xuatXu);
                return sp;
